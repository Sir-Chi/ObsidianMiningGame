...
execute at @e[tag=lobby_locator] if block ~ ~ ~ air run schedule function omg:master/create_lobby 10t
execute at @e[tag=lobby_locator] unless block ~ ~ ~ air run function omg:master/locate_lobby
