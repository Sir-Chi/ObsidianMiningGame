...
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score BlueTeam score = #Leader score run tellraw @a ["",{"text":"Blue Team","color":"blue"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"BlueTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score GreenTeam score = #Leader score run tellraw @a ["",{"text":"Green Team","color":"green"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"GreenTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score RedTeam score = #Leader score run tellraw @a ["",{"text":"Red Team","color":"red"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"RedTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score YellowTeam score = #Leader score run tellraw @a ["",{"text":"Yellow Team","color":"yellow"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"YellowTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score PurpleTeam score = #Leader score run tellraw @a ["",{"text":"Purple Team","color":"dark_purple"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"PurpleTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score BlackTeam score = #Leader score run tellraw @a ["",{"text":"Black Team","color":"black"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"BlackTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
execute if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score GoldTeam score = #Leader score run tellraw @a ["",{"text":"Gold Team","color":"gold"}," has ended the timed Quest for Everything, winning with a score of ",{"score":{"name":"GoldTeam","objective":"score"},"color":"gold"}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
playsound music.credits record @a ~ ~ ~ 0.2
